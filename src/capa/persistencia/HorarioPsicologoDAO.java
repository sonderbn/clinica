...
public class HorarioPsicologoDAO {
    ...
    private static final String MENSAJE = "Error al intentar mostrar los horarios.";  
    ...
    public void mostrarHorarioDisponible(DefaultTableModel modelo){
        String consultaSQL = "select hp.codigo, hp.fecha,ps.nombrepsicologo,ps.especialidad, hp.horaentrada, hp.horasalida from horariopsicologo hp inner join psicologo ps on hp.idpsicologo = ps.idpsicologo where to_date(fecha, 'YYYY-MM-dd')>=current_date and estado='Disponible'";
        PreparedStatement sentencia;
