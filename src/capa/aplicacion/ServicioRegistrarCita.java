...
public class ServicioRegistrarCita {
    ...
    public HorarioPsicologo buscarHorarioPsicologo(String codigo) throws SQLException {
        gestorJDBC.abrirConexion();
    ...
    public void mostrarHorario(DefaultTableModel modelo) throws SQLException {
        gestorJDBC.abrirConexion();
