...
public class ServicioRegistrarPaciente {
    ...
    public int agregarPaciente(Paciente paciente) throws Exception {
        ...
        if (paciente.validarNombre()) {
            ...
            throw new IllegalArgumentException("Verifique el número de DNI tiene " + paciente.validarCantidaDigitosDNI() + " dígitos.");
            ...
            throw new IllegalArgumentException("Verifique el número de celular tiene " + paciente.validarCantidaDigitosTelefono() + " dígitos.");
        }                
        gestorJDBC.abrirConexion();
