...
public class ServicioRegistrarHorarioPsicologo {
    ...
    public void buscarPsicologoEnHorario(DefaultTableModel modelo, String nombre) throws SQLException {
        gestorJDBC.abrirConexion();
    ...
    public void buscarEspecialidadPsicologoEnHorario(DefaultTableModel modelo, String especialidad) throws SQLException {
        gestorJDBC.abrirConexion();
    ...
    public void buscarFechaEnHorario(DefaultTableModel modelo, String fecha) throws SQLException {
        gestorJDBC.abrirConexion();
        horarioPsicologoDAO.buscarPorFechaEnHorario(modelo, fecha);
        gestorJDBC.cerrarConexion();
    }
    
     public int agregarHorarioPsicologo(HorarioPsicologo horarioPsicologo) throws SQLException {
